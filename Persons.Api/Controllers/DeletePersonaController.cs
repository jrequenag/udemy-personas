...
public class DeletePersonaController : ControllerBase {
    private readonly ILogger<RemoveIdentityDocumentController> _logger;
    private readonly ICommandDispatcher _commandDispatcher;

    public DeletePersonaController(ILogger<RemoveIdentityDocumentController> logger
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult> DeletePersona(Guid id, DeletePersonCommand command) {
        try {
            command.Id = id;
